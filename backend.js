...
render=function(){let body=route==='home'?home():route==='apps'?apps():route==='colloc'?colloc():route==='admin'?admin():route==='profile'?profile():home();document.querySelector('#app').innerHTML=`<div class="shell">${top()}${body}${modalHtml()}<div class="demo" style="background:#dcf5df;border-color:#a8d7ae">● Backend sécurisé actif</div></div>`};
